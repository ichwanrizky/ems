...
export async function POST(req: Request) {
  try {
    ...
    jam_masuk_department.setFullYear(
      ConvertDateZeroHours(DateNowFormat() as Date).getFullYear()
    );
    jam_masuk_department.setMonth(
      ConvertDateZeroHours(DateNowFormat() as Date).getMonth()
    );
    jam_masuk_department.setDate(
      ConvertDateZeroHours(DateNowFormat() as Date).getDate()
    );
